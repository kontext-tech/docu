...
namespace Kontext.Data
{
    public interface IAccountManager
    {
        ...
        Task<ApplicationRole> GetRoleLoadRelatedByIdAsync(string roleId);
        ...
        Task<ApplicationUser> GetUserLoadRelatedByIdAsync(string userId);
        Task<ApplicationUser> GetRoleLoadRelatedByUserNameAsync(string userName);
        Task<Tuple<List<ApplicationUser>, int>> SearchUsersAsync(string keyWord, int page, int pageSize);
        Task<Tuple<bool, string[]>> DisableUserAsync(ApplicationUser user);
        Task<Tuple<bool, string[]>> EnableUserAsync(ApplicationUser user);
    }
}
